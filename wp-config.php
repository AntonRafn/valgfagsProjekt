...
if ($_SERVER['SERVER_NAME'] == 'valgfagsprojekttester.local') {
	...
	define('DB_NAME', 'ci1oaw5p7_7eee51fb_wordpress');

	/** Database username */
	define('DB_USER', 'ci1oaw5p7_7eee51fb_wordpress');

	/** Database password */
	define('DB_PASSWORD', 'dW#7Joc4TGa45XDJ6AtA');

	/** Database hostname */
	define('DB_HOST', 'mysql.ci1oaw5p7.service.one');
}
